...
if __name__ == '__main__':
    ...
    text = u"""ウマ味爆発ッ！奮える神の汁っ！！
一口で虜ッ！神域での恍惚テイストッ！！
本店彷彿とさせるウマさ極めたKAMI汁ウッメェェッ！！
液体アブラ効いてて激しくウッメェェッ！！震え抑えながらKAMI汁飲んだ。
コレメッチャ好きィ！！塩気効いた汁で神域。
神域ィ！！二郎観大幅に書き換わる衝撃的ウマ味、奮えながら貪る。
一口で、奮えMAX、至高の神汁。
コクうま汁、神の汁。一口で神の領域に突入。
コクうま汁、旨味と塩気のPAPP汁。一口で完飲へのビジョン明確になる最上最高の神汁ぅ！！
ミルキィでウマ味極まる夢中の神汁っ！！
一口啜った瞬間、完飲が約束されるもの。神話級。
神域のバランス汁。我を忘れる夢中汁。奮えながら啜る。
"""
