...
if __name__ == '__main__':
    ...
    ウッメェェッ！！神域のホロ肉。完全に虜。
    端豚、巻豚、神域ィ！！
    ホロホロジューシー至高の一品。神域で安定。
    ほぐれる食感、ブタ切れが無念に思えるもの。これぞ神域のブタ。
    塩気とアブラの興奮仕様ッ！！我忘れて貪り飲んだ神話ブタ。
    プリと柔らか、味染みた最ッ高にウマい神ブタs！！
    ウッメェェッ！！トロッとほろけて神域で安定。
    しっとりムッチリ神話級！！我忘れて貪れるもの。
    天に乞う、ブタ肉10枚、喰う権利。神域最高、超ウッメェェェッ！！
    肉のウマ味爆発ッ！！夢中で頬張った。神域にて感涙。
    肉質しっかり、ジューシィで、純粋に神なるもの。
    ウッメェェッ！！フワフワで脂身甘い神域ぶた。
"""
